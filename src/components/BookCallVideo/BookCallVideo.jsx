...
function BookCallVideo() {
  return (
    <div className=" 2xl:bg-video-call-desk bg-cover h-602 bg-no-repeat sm:bg-video-call-mbl sm:h-724">
      ...
      <div className="2xl:hidden sm:flex sm:justify-center sm:mb-20 sm:pt-80">
        <Button value="step 2" color="green" width={92} height={46} />
      </div>
      <div className="2xl:text-2xl sm:text-xl text-white text-center">
      ...
      <div className="flex justify-center pt-180">
        <div class="2xl:text-16 sm:text-base text-white text-center 2xl:w-44% sm:w-72%">
